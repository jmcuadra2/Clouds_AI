...
namespace nimbus
{
	...
	*/
	...
	protected:
		...
		//JMCT
		std::string getPositionsAxis(int axis);
        void writeCSV();
	public:
		Cumulus();
		virtual void create(int spheres, GLfloat siz, glm::vec3& center, GLfloat nuX, GLfloat sigX, GLfloat nuY, GLfloat sigY, GLfloat nuZ, GLfloat sigZ, bool isFlat, bool optimize);
