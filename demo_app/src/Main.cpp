...
int main(int argc, char* argv[])
{
	...
	try {
       ...
       /* for (int i = 0; i < 10; i++)
		...
		glm::vec3 center1 = glm::vec3(-30.0, 4.5, -10.0);
		myCloud[0].create(35, 2.9, center1, 0.0, 3.8, 0.0, 1.7, 0.0, 3.7, true, false);
		glm::vec3 center2 = glm::vec3(-26, 3.0, -35.0);
		myCloud[1].create(35, 2.9, center2, 0.0, 3.8, 0.0, 1.0, 0.0, 3.7, true, false);
