...
namespace nimbus
{
	...
	*/
	...
	private:
		...
		int size; // 3D grid size
        float *u, *v, *w, *uPrev, *vPrev, *wPrev; //  Array pointers for 3D fluid components
	private:
	...
	public:
        ...
        FluidCPU(int dimM, int dimN, int dimO, float dt, float diff, float visc);
		...
		void sim();
    //JMCT
        void setPrevForceSource(float force);
